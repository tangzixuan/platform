...
import { type DomainHelperOperations, type SqlStorage } from '@hcengineering/server-core'
...
export async function createTable (client: SqlStorage, domains: string[]): Promise<void> {
  if (domains.length === 0) {
    return
  }
